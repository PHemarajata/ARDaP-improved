...
${SNPEFF_CMD} eff -no-downstream -no-intergenic -ud 100 -formatEff -v -dataDir ${baseDir}/resources/snpeff ${variant_genome_path} out.vcf > out.annotated.vcf
